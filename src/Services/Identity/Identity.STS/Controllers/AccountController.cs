...
using Identity.STS.ViewModels.Account;
using IdentityModel;
...
namespace Identity.STS.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            if (remoteError != null)
            {
                ModelState.AddModelError(string.Empty, "ErrorExternalProvider");
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // [TODO]
                // await _emailSender.SendEmailAsync(user.Email, "ResetPasswordTitle"], "ResetPasswordBody", HtmlEncoder.Default.Encode(callbackUrl)]);
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            _logger.LogInformation("PasswordChangedLog");
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorViewModel model)
        {
            ...
            if (!is2faTokenValid)
            {
                ModelState.AddModelError("ErrorCode", "InvalidVerificationCode");
                await LoadSharedKeyAndQrCodeUriAsync(user, model);
                return View(model);
            }
            ...
            _logger.LogInformation("SuccessUserEnabled2FA");

            StatusMessage = "AuthenticatorVerified";
        ...
        public async Task<IActionResult> ForgetTwoFactorClient()
        {
            ...
            StatusMessage = "SuccessForgetBrowser2FA";
        ...
        public async Task<IActionResult> Disable2faWarning()
        {
            ...
            {
                throw new ApplicationException("ErrorDisable2FA");
            }
        ...
        public async Task<IActionResult> Disable2fa()
        {
            ...
            _logger.LogInformation("SuccessDisabled2FA");
        ...
        public async Task<IActionResult> ResetAuthenticator()
        {
            ...
            _logger.LogInformation("SuccessResetAuthenticationKey");
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            if (!user.TwoFactorEnabled)
            {
                AddError("ErrorGenerateCodesWithout2FA");
                return View();
            }

            var recoveryCodes = await _userManager.GenerateNewTwoFactorRecoveryCodesAsync(user, 10);

            _logger.LogInformation("UserGenerated2FACodes");
        ...
        public async Task<IActionResult> GenerateRecoveryCodesWarning()
        {
            ...
            if (!user.TwoFactorEnabled)
            {
                throw new ApplicationException("Error2FANotEnabled");
            }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("iDiary.Idenity.STS"),
